...
class Predictor(BasePredictor):
    ...
    **[UPD 17.10.2021]** Exposed more parameters
    ...
    def predict(
        ...
        os.system(f"ffmpeg -y -i \"{audio_file}\" -vn -acodec pcm_s16le /tmp/audio.wav")
        audio_file = '/tmp/audio.wav'
        is_lucid_sonic_dreams = model_type not in ["imagenet (XL)", "ffhq (XL)", "pokemon (XL)", "humans (StyleGAN-humans)"]
        ...
        #   %cd /content/StyleGAN-Human/
            ...
            repo_path = "/content/stylegan_xl/"
        else:
            repo_path = "/content/stylegan2/"
        os.chdir(repo_path)
        ...
        L = lsd.LucidSonicDream(song = audio_file,
                            style = projected_gan, 
        ...
        if model_type == "humans":
            os.system('ffmpeg -y -i output.mp4 -vcodec libx264 -filter_complex "[0]pad=w=820:h=ih:x=153:y=0:color=black" $output_path/lowres_output.mp4')
        else:
            os.system("cp output.mp4 $output_path/lowres_output.mp4")
